...
using ITControl.Application.Supplies.Services;
using ITControl.Application.SuppliesMovements.Interfaces;
using ITControl.Application.SuppliesMovements.Services;
...
public static class DependencyInjectionApi
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<ISuppliesMovementsRepository, SuppliesMovementsRepository>();
        services.AddScoped<ISuppliesMovementsService, SuppliesMovementsService>();
