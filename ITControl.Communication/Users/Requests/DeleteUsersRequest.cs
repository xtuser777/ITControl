...
public class DeleteUsersRequest
{
    ...
    public static ValidationResult? ValidateLoggedUserId(Guid? loggedUserId, ValidationContext context)
    {
        ...
        if (loggedUserId.Value.ToString() == idRoute)
        {
            return new ValidationResult(string.Format(Errors.DontRemoveYourself));
        }
