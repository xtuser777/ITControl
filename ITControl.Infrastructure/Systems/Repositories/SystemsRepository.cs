...
public class SystemsRepository(ApplicationDbContext context) : ISystemsRepository
{
    ...
    private IQueryable<Domain.Systems.Entities.System> BuildQuery(
        IQueryable<Domain.Systems.Entities.System> query,
        Guid? id = null,
        string? name = null,
        string? version = null,
        DateOnly? implementedAt = null,
    ...
    private IQueryable<Domain.Systems.Entities.System> BuildOrderBy(
        IQueryable<Domain.Systems.Entities.System> query, 
        string? orderByName = null,
        string? orderByVersion = null, 
        string? orderByImplementedAt = null, 
